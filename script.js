document.addEventListener('DOMContentLoaded', () => {
  ...
  const newsData = [
    { date: '2026.05.06', badge: 'イベント', badgeClass: 'event', title: '【日程変更】心霊スポット配信は5月7日(木) 20:30〜に変更となりました' },
  ...
  const scheduleData = [
    ...
    { date: '2026.05.07', time: '20:30', type: 'HORROR', title: '心霊スポット（みーちゃん・ぽんちゃん・野田）', venue: 'KICK', image: 'ponchan.jpg' },
